...
function Explain() {
  return (
    <section css={sizeWrapper}>
      ...
      <br />
      <ExplainText summary="navbar의 식당 메뉴에서 온수냠냠냠 식당들을 관리할 수 있습니다. 해당 식당을 삭제, 수정할 수 있으며 새로운 식당도 추가할 수 있도록 구성되어 있습니다." />
      <ExplainText summary="식당의 메뉴들을 수정할 수 있습니다. 메뉴의 종류나 가격이 아주 정확하지 않아서 꾸준한 관리가 필요할 것 같아요." />
